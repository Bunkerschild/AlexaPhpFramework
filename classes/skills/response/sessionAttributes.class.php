...
namespace AlexaPhpFramework\skills\response;

class sessionAttributes implements \JsonSerializable
{
    use \AlexaPhpFramework\traits\skills\response\sessionAttributes;
