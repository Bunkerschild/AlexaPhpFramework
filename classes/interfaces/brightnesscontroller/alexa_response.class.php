...
namespace AlexaPhpFramework\interfaces\brightnesscontroller;

final class alexa_response implements \JsonSerializable
{
    use \AlexaPhpFramework\traits\interfaces\brightnesscontroller\alexa_response;
    
    use \AlexaPhpFramework\traits\functions\__get;
    use \AlexaPhpFramework\traits\functions\__set_once;
