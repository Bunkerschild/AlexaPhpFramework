...
namespace AlexaPhpFramework\common\properties;

class brightnesscontroller implements \JsonSerializable
{
    use \AlexaPhpFramework\traits\common\properties;
    use \AlexaPhpFramework\traits\common\properties\brightnesscontroller;
