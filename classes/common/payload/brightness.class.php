...
namespace AlexaPhpFramework\common\payload;

class brightness implements \JsonSerializable
{
    use \AlexaPhpFramework\traits\common\payload;
    use \AlexaPhpFramework\traits\common\payload\brightness;

    use \AlexaPhpFramework\traits\functions\__get_any;
    use \AlexaPhpFramework\traits\functions\__set_any;
    use \AlexaPhpFramework\traits\functions\get_instance;
    use \AlexaPhpFramework\traits\functions\to_json;
}
