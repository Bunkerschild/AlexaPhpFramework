...
trait context
{
    ...
    {
        if (class_exists("AlexaPhpFramework\\interfaces\\brightnesscontroller\\alexa_response", false))
        {
            $properties = "\\AlexaPhpFramework\\common\\properties\\brightnesscontroller";
        }
        else
        {
            $properties = null;
