...
namespace AlexaPhpFramework\traits\common\payload;
...
trait grant
{
    ...
    {   
        if (!isset($payload->grant))
            unset($this->grant);
        else
            $this->grant = new \AlexaPhpFramework\common\grant($payload->grant);

        if (!isset($payload->grantee))
            unset($this->grantee);
        else
            $this->grantee = new \AlexaPhpFramework\common\grantee($payload->grantee);
    }
