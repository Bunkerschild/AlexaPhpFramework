...
trait brightness
{
    private $brightnessDelta = null;
    private $brightness = null;
    
    function __construct($payload)
    {   
        if (!isset($payload->brightnessDelta))
            unset($this->brightnessDelta);
        else
            $this->brightnessDelta = $payload->brightnessDelta;

        if (!isset($payload->brightness))
            unset($this->brightness);
        else
