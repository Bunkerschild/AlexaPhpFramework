...
namespace AlexaPhpFramework\traits\interfaces\discovery;
...
trait alexa_request
{
    ...
    {
        $this->directive = new \AlexaPhpFramework\common\directive($json->directive);
    }
    
    public function create_response()
    {
        return new \AlexaPhpFramework\interfaces\discovery\alexa_response($this->jsonSerialize());
    }
}
