...
trait alexa_response
{
    ...
    private $sessionAttributes = null;
    private $response = null;

    function __construct($request)
    {
        $this->version = $request->version;
        $this->sessionAttributes = new \AlexaPhpFramework\skills\response\sessionAttributes;
        $this->response = new \AlexaPhpFramework\skills\response\response;
    }
